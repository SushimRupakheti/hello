...
class AuthLocalDatasource implements IAuthLocalDataSource {
  ...
  Future<AuthHiveModel?> login(String email, String password) async {
    try {
      ...
      if(user != null){
        await _userSessionServices.saveUserSession(userId: user.authId!, email: user.email, username: user.username, fullName: user.fullName, phoneNumber: user.phoneNumber, batchId: user.batchId, profilePicture:user.profilePicture?? '');
      }

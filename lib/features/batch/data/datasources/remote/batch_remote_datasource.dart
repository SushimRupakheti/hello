...
final batchRemoteProvider = Provider<BatchRemoteDatasource>((ref){
...
class BatchRemoteDatasource implements IBatchRemoteDataSource {
  ...
  BatchRemoteDatasource({required ApiClient apiClient}):_apiClient=apiClient;
